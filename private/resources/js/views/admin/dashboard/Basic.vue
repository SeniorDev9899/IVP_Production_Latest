    ...
    <div class="row">
      <div class="col-md-12 col-lg-6 col-xl-3">
        <a class="dashbox" href="#">
          ...
          <span class="desc"> {{ $t("basic.all_users") }} </span>
        </a>
      </div>
      <div class="col-md-12 col-lg-6 col-xl-3">
        <a class="dashbox" href="#">
          ...
          <span class="desc"> {{ $t("basic.sys_admin") }} </span>
        </a>
      </div>
      <div class="col-md-12 col-lg-6 col-xl-3">
        <a class="dashbox" href="#">
          ...
          <span class="desc"> {{ $t("basic.regional_admins") }} </span>
        </a>
      </div>
      <div class="col-md-12 col-lg-6 col-xl-3">
        <a class="dashbox" href="#">
          ...
          <span class="desc"> {{ $t("basic.practitioners") }} </span>
        </a>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-lg-12 col-xl-6 mt-2">
        <div class="card">
          <div class="card-header">
            <h6>
              <i class="icon-fa icon-fa-bar-chart text-success" />{{
                $t("basic.sales_chat")
              }}
            </h6>
          </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <table class="table">
              <thead>
                <tr>
                  <th>{{ $t("users.table.full_name") }}</th>
                  <th>{{ $t("users.table.gender") }}</th>
                  <th>{{ $t("users.table.verification_status") }}</th>
                  <th>{{ $t("users.table.action_name") }}</th>
                </tr>
              </thead>
              <tbody>
